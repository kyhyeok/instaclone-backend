/*
  ...
  - You are about to drop the column `hashtah` on the `Hashtag` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "Hashtag.hashtah_unique";

-- AlterTable
ALTER TABLE "Hashtag" DROP COLUMN "hashtah",
